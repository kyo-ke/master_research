...
class TestJob(unittest.TestCase):
    ...
    def __init__(self,*args, **kwargs):
        ...
        job_dict = jobs
        self.microservice = Microservice(hardware, self.microservice_id, job_list, job_dict)
    ...
    def test_generate_message(self):
        ...
        self.assertEqual(message.to_hardware, self.parent_info["parent_hardware"])
        self.assertEqual(message.to_microservice, self.parent_info["parent_microservice"])
